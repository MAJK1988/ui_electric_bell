...
class Thermometer extends StatefulWidget{
  ...
  const Thermometer({Key? key,required this.temperature,required this.endValue}) : super(key: key);
  ...
  SfLinearGauge(
    ...
    markerPointers: [
            LinearWidgetPointer(
              ...
              value: temperature,
              child: Text(getString(temperature),
                style: TextStyle(
...
String getString(double value){
  ...
  if(value > 12 && value < 38){return 'Medl'; }
  else {return 'Hot';}
}