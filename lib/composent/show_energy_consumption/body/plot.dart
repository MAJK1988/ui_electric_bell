...
import 'package:ui_electric_bell/composent/show_energy_consumption/body/time_scale_type.dart';
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: SfCartesianChart(
                        ...
                        series: <LineSeries<ConsomeElectricPowerData, String>>[
                          ...
                          if (widget.plotTwoLine)
                            LineSeries<ConsomeElectricPowerData, String>(
                                dataSource: getRequiredline(
                                    data[stateTileScaler.indexOf(true)],
                                    dataType[stateTileScaler.indexOf(true)],
                                    widget.requiredPower),
