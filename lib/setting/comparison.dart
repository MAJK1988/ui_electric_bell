...
class Comperson extends StatefulWidget{
  ...
  const Comperson({Key? key, required this.size,required this.title, required this.data}) : super(key: key);
          ...
          children: [
            Padding(
              ...
              child: Stack(
                ...
                children: [
                  Text((widget.data.period!)+' average : ',style:
                   TextStyle(
            ...
            Stack(
              ...
              children: [
                Text((widget.data.period!)+' required : ',style:
                   TextStyle(
